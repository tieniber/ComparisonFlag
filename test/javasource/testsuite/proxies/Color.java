...
public class Color
{
	...
	public enum MemberNames
	{
		...
		IsPrimary("IsPrimary"),
		ColorCode("ColorCode"),
		Color_Color("TestSuite.Color_Color");
	...
	/**
	 * @return value of Color_Color
	 */
	public final testsuite.proxies.Color getColor_Color() throws com.mendix.core.CoreException
	{
		return getColor_Color(getContext());
	}
	 ...
	 * @return value of Color_Color
	 */
	public final testsuite.proxies.Color getColor_Color(com.mendix.systemwideinterfaces.core.IContext context) throws com.mendix.core.CoreException
	{
		testsuite.proxies.Color result = null;
		com.mendix.systemwideinterfaces.core.IMendixIdentifier identifier = getMendixObject().getValue(context, MemberNames.Color_Color.toString());
		if (identifier != null)
	...
	/**
	 * Set value of Color_Color
	 * @param color_color
	 */
	public final void setColor_Color(testsuite.proxies.Color color_color)
	{
		setColor_Color(getContext(), color_color);
	}
	 ...
	 * @param color_color
	 */
	public final void setColor_Color(com.mendix.systemwideinterfaces.core.IContext context, testsuite.proxies.Color color_color)
	{
		if (color_color == null)
			getMendixObject().setValue(context, MemberNames.Color_Color.toString(), null);
		else
			getMendixObject().setValue(context, MemberNames.Color_Color.toString(), color_color.getMendixObject().getId());
	}
